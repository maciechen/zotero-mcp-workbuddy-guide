...
将 Zotero 文献库接入 WorkBuddy，用自然语言对话完成文献搜索、PDF 批注整理、文献综述草稿等任务。本仓库提供**完整的中文配置指南**，支持本地模式和云端模式，且设计为 **AI 可自主执行**——你只需一句话，AI 自动完成配置。
...
```bash
git clone https://github.com/your-org/zotero-mcp-workbuddy-guide.git
```
...
2. 根据你的场景选择对应文档
3. 复制 [configs/](configs/) 下模板到 `~/.workbuddy/mcp.json`
...
| 官方文档 | [stevenyuyy.com/zotero-mcp](https://stevenyuyy.com/zotero-mcp/) |
| CEIBS LibGuide | [AI 文献管理](https://ceibs.libguides.com/reference_management/ai) |
